...
def static_obstacle_node(obstacle_id, delay, static_obstacles_file):
    return TimerAction(
        period=delay,
        actions=[
            Node(
                package="smart_city",
                executable="static_obstacle_spawner_node",
                name=f"static_obstacle_{obstacle_id}",
                parameters=[{
                    "obstacle_id": obstacle_id,
                    "obstacles_config_file": static_obstacles_file,
...
def generate_launch_description():
    ...
    for obstacle in static_obstacles_data["static_obstacles"]:
